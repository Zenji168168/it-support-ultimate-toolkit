...
if %ERRORLEVEL% equ 0 (
    ...
    gh release create v%NEW_VER% "%~dp0IT-Support-Toolkit-Setup.exe" "%~dp0IT-Support-Toolkit-Portable.zip" "%~dp0IT-Support-Toolkit-v%NEW_VER%.zip" --title "IT Support Ultimate Toolkit v%NEW_VER% Enterprise" --notes "Official Enterprise Release with 130 IT, Network, Sysadmin & CCTV Utilities by MEUK THAREACH"
)
